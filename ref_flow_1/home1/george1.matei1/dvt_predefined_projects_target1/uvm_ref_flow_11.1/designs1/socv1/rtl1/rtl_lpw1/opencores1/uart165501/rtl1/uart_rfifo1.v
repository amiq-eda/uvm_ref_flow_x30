//////////////////////////////////////////////////////////////////////
////                                                              ////
////  uart_rfifo1.v (Modified1 from uart_fifo1.v)                    ////
////                                                              ////
////                                                              ////
...
// Revision1 1.3  2003/06/11 16:37:47  gorban1
...
//
// Revision1 1.2  2002/07/29 21:16:18  gorban1
...
raminfr1 #(fifo_pointer_w1,8,fifo_depth1) rfifo1  
        (.clk1(clk1), 
			.we1(push1), 
			.a(top), 
			.dpra1(bottom1), 
			.di1(data_in1[fifo_width1-1:fifo_width1-8]), 
			.dpo1(data8_out1)
		); 
...
begin
  ...
  if(push1 & ~pop1 & (count==fifo_depth1))
    overrun1   <= #1 1'b1;
end   // always


// please1 note1 though1 that data_out1 is only valid one clock1 after pop1 signal1
assign data_out1 = {data8_out1,fifo[bottom1]};

// Additional1 logic for detection1 of error conditions1 (parity1 and framing1) inside the FIFO
// for the Line1 Status Register bit 7

wire	[2:0]	word01 = fifo[0];
wire	[2:0]	word11 = fifo[1];
wire	[2:0]	word21 = fifo[2];
wire	[2:0]	word31 = fifo[3];
wire	[2:0]	word41 = fifo[4];
wire	[2:0]	word51 = fifo[5];
wire	[2:0]	word61 = fifo[6];
wire	[2:0]	word71 = fifo[7];

wire	[2:0]	word81 = fifo[8];
wire	[2:0]	word91 = fifo[9];
wire	[2:0]	word101 = fifo[10];
wire	[2:0]	word111 = fifo[11];
wire	[2:0]	word121 = fifo[12];
wire	[2:0]	word131 = fifo[13];
wire	[2:0]	word141 = fifo[14];
wire	[2:0]	word151 = fifo[15];

// a 1 is returned if any of the error bits in the fifo is 1
assign	error_bit1 = |(word01[2:0]  | word11[2:0]  | word21[2:0]  | word31[2:0]  |
            		      word41[2:0]  | word51[2:0]  | word61[2:0]  | word71[2:0]  |
            		      word81[2:0]  | word91[2:0]  | word101[2:0] | word111[2:0] |
            		      word121[2:0] | word131[2:0] | word141[2:0] | word151[2:0] );
