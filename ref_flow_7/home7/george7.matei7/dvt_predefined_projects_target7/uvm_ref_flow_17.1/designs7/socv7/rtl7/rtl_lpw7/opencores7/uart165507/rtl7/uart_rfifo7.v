//////////////////////////////////////////////////////////////////////
////                                                              ////
////  uart_rfifo7.v (Modified7 from uart_fifo7.v)                    ////
////                                                              ////
////                                                              ////
...
// Revision7 1.3  2003/06/11 16:37:47  gorban7
...
//
// Revision7 1.2  2002/07/29 21:16:18  gorban7
...
raminfr7 #(fifo_pointer_w7,8,fifo_depth7) rfifo7  
        (.clk7(clk7), 
			.we7(push7), 
			.a(top), 
			.dpra7(bottom7), 
			.di7(data_in7[fifo_width7-1:fifo_width7-8]), 
			.dpo7(data8_out7)
		); 
...
begin
  ...
  if(push7 & ~pop7 & (count==fifo_depth7))
    overrun7   <= #1 1'b1;
end   // always


// please7 note7 though7 that data_out7 is only valid one clock7 after pop7 signal7
assign data_out7 = {data8_out7,fifo[bottom7]};

// Additional7 logic for detection7 of error conditions7 (parity7 and framing7) inside the FIFO
// for the Line7 Status Register bit 7

wire	[2:0]	word07 = fifo[0];
wire	[2:0]	word17 = fifo[1];
wire	[2:0]	word27 = fifo[2];
wire	[2:0]	word37 = fifo[3];
wire	[2:0]	word47 = fifo[4];
wire	[2:0]	word57 = fifo[5];
wire	[2:0]	word67 = fifo[6];
wire	[2:0]	word77 = fifo[7];

wire	[2:0]	word87 = fifo[8];
wire	[2:0]	word97 = fifo[9];
wire	[2:0]	word107 = fifo[10];
wire	[2:0]	word117 = fifo[11];
wire	[2:0]	word127 = fifo[12];
wire	[2:0]	word137 = fifo[13];
wire	[2:0]	word147 = fifo[14];
wire	[2:0]	word157 = fifo[15];

// a 1 is returned if any of the error bits in the fifo is 1
assign	error_bit7 = |(word07[2:0]  | word17[2:0]  | word27[2:0]  | word37[2:0]  |
            		      word47[2:0]  | word57[2:0]  | word67[2:0]  | word77[2:0]  |
            		      word87[2:0]  | word97[2:0]  | word107[2:0] | word117[2:0] |
            		      word127[2:0] | word137[2:0] | word147[2:0] | word157[2:0] );
