//////////////////////////////////////////////////////////////////////
////                                                              ////
////  uart_rfifo21.v (Modified21 from uart_fifo21.v)                    ////
////                                                              ////
////                                                              ////
...
// Revision21 1.3  2003/06/11 16:37:47  gorban21
...
//
// Revision21 1.2  2002/07/29 21:16:18  gorban21
...
wire [7:0] data8_out21;
// flags21 FIFO
reg	[2:0]	fifo[fifo_depth21-1:0];
...
raminfr21 #(fifo_pointer_w21,8,fifo_depth21) rfifo21  
        (.clk21(clk21), 
			.we21(push21), 
			.a(top), 
			.dpra21(bottom21), 
			.di21(data_in21[fifo_width21-1:fifo_width21-8]), 
			.dpo21(data8_out21)
		); 
...
begin
  ...
  if(push21 & ~pop21 & (count==fifo_depth21))
    overrun21   <= #1 1'b1;
end   // always


// please21 note21 though21 that data_out21 is only valid one clock21 after pop21 signal21
assign data_out21 = {data8_out21,fifo[bottom21]};

// Additional21 logic for detection21 of error conditions21 (parity21 and framing21) inside the FIFO
// for the Line21 Status Register bit 7

wire	[2:0]	word021 = fifo[0];
wire	[2:0]	word121 = fifo[1];
wire	[2:0]	word221 = fifo[2];
wire	[2:0]	word321 = fifo[3];
wire	[2:0]	word421 = fifo[4];
wire	[2:0]	word521 = fifo[5];
wire	[2:0]	word621 = fifo[6];
wire	[2:0]	word721 = fifo[7];

wire	[2:0]	word821 = fifo[8];
wire	[2:0]	word921 = fifo[9];
wire	[2:0]	word1021 = fifo[10];
wire	[2:0]	word1121 = fifo[11];
wire	[2:0]	word1221 = fifo[12];
wire	[2:0]	word1321 = fifo[13];
wire	[2:0]	word1421 = fifo[14];
wire	[2:0]	word1521 = fifo[15];

// a 1 is returned if any of the error bits in the fifo is 1
assign	error_bit21 = |(word021[2:0]  | word121[2:0]  | word221[2:0]  | word321[2:0]  |
            		      word421[2:0]  | word521[2:0]  | word621[2:0]  | word721[2:0]  |
            		      word821[2:0]  | word921[2:0]  | word1021[2:0] | word1121[2:0] |
            		      word1221[2:0] | word1321[2:0] | word1421[2:0] | word1521[2:0] );
