//////////////////////////////////////////////////////////////////////
////                                                              ////
////  uart_rfifo27.v (Modified27 from uart_fifo27.v)                    ////
////                                                              ////
////                                                              ////
...
// Revision27 1.3  2003/06/11 16:37:47  gorban27
...
//
// Revision27 1.2  2002/07/29 21:16:18  gorban27
...
wire [7:0] data8_out27;
// flags27 FIFO
reg	[2:0]	fifo[fifo_depth27-1:0];
...
raminfr27 #(fifo_pointer_w27,8,fifo_depth27) rfifo27  
        (.clk27(clk27), 
			.we27(push27), 
			.a(top), 
			.dpra27(bottom27), 
			.di27(data_in27[fifo_width27-1:fifo_width27-8]), 
			.dpo27(data8_out27)
		); 
...
begin
  ...
  if(push27 & ~pop27 & (count==fifo_depth27))
    overrun27   <= #1 1'b1;
end   // always


// please27 note27 though27 that data_out27 is only valid one clock27 after pop27 signal27
assign data_out27 = {data8_out27,fifo[bottom27]};

// Additional27 logic for detection27 of error conditions27 (parity27 and framing27) inside the FIFO
// for the Line27 Status Register bit 7

wire	[2:0]	word027 = fifo[0];
wire	[2:0]	word127 = fifo[1];
wire	[2:0]	word227 = fifo[2];
wire	[2:0]	word327 = fifo[3];
wire	[2:0]	word427 = fifo[4];
wire	[2:0]	word527 = fifo[5];
wire	[2:0]	word627 = fifo[6];
wire	[2:0]	word727 = fifo[7];

wire	[2:0]	word827 = fifo[8];
wire	[2:0]	word927 = fifo[9];
wire	[2:0]	word1027 = fifo[10];
wire	[2:0]	word1127 = fifo[11];
wire	[2:0]	word1227 = fifo[12];
wire	[2:0]	word1327 = fifo[13];
wire	[2:0]	word1427 = fifo[14];
wire	[2:0]	word1527 = fifo[15];

// a 1 is returned if any of the error bits in the fifo is 1
assign	error_bit27 = |(word027[2:0]  | word127[2:0]  | word227[2:0]  | word327[2:0]  |
            		      word427[2:0]  | word527[2:0]  | word627[2:0]  | word727[2:0]  |
            		      word827[2:0]  | word927[2:0]  | word1027[2:0] | word1127[2:0] |
            		      word1227[2:0] | word1327[2:0] | word1427[2:0] | word1527[2:0] );
