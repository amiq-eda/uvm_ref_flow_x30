//////////////////////////////////////////////////////////////////////
////                                                              ////
////  uart_rfifo12.v (Modified12 from uart_fifo12.v)                    ////
////                                                              ////
////                                                              ////
...
// Revision12 1.3  2003/06/11 16:37:47  gorban12
...
//
// Revision12 1.2  2002/07/29 21:16:18  gorban12
...
wire [7:0] data8_out12;
// flags12 FIFO
reg	[2:0]	fifo[fifo_depth12-1:0];
...
raminfr12 #(fifo_pointer_w12,8,fifo_depth12) rfifo12  
        (.clk12(clk12), 
			.we12(push12), 
			.a(top), 
			.dpra12(bottom12), 
			.di12(data_in12[fifo_width12-1:fifo_width12-8]), 
			.dpo12(data8_out12)
		); 
...
begin
  ...
  if(push12 & ~pop12 & (count==fifo_depth12))
    overrun12   <= #1 1'b1;
end   // always


// please12 note12 though12 that data_out12 is only valid one clock12 after pop12 signal12
assign data_out12 = {data8_out12,fifo[bottom12]};

// Additional12 logic for detection12 of error conditions12 (parity12 and framing12) inside the FIFO
// for the Line12 Status Register bit 7

wire	[2:0]	word012 = fifo[0];
wire	[2:0]	word112 = fifo[1];
wire	[2:0]	word212 = fifo[2];
wire	[2:0]	word312 = fifo[3];
wire	[2:0]	word412 = fifo[4];
wire	[2:0]	word512 = fifo[5];
wire	[2:0]	word612 = fifo[6];
wire	[2:0]	word712 = fifo[7];

wire	[2:0]	word812 = fifo[8];
wire	[2:0]	word912 = fifo[9];
wire	[2:0]	word1012 = fifo[10];
wire	[2:0]	word1112 = fifo[11];
wire	[2:0]	word1212 = fifo[12];
wire	[2:0]	word1312 = fifo[13];
wire	[2:0]	word1412 = fifo[14];
wire	[2:0]	word1512 = fifo[15];

// a 1 is returned if any of the error bits in the fifo is 1
assign	error_bit12 = |(word012[2:0]  | word112[2:0]  | word212[2:0]  | word312[2:0]  |
            		      word412[2:0]  | word512[2:0]  | word612[2:0]  | word712[2:0]  |
            		      word812[2:0]  | word912[2:0]  | word1012[2:0] | word1112[2:0] |
            		      word1212[2:0] | word1312[2:0] | word1412[2:0] | word1512[2:0] );
