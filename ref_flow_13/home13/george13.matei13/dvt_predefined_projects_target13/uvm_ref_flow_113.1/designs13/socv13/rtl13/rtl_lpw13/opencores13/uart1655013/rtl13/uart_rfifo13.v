//////////////////////////////////////////////////////////////////////
////                                                              ////
////  uart_rfifo13.v (Modified13 from uart_fifo13.v)                    ////
////                                                              ////
////                                                              ////
...
// Revision13 1.3  2003/06/11 16:37:47  gorban13
...
//
// Revision13 1.2  2002/07/29 21:16:18  gorban13
...
wire [7:0] data8_out13;
// flags13 FIFO
reg	[2:0]	fifo[fifo_depth13-1:0];
...
raminfr13 #(fifo_pointer_w13,8,fifo_depth13) rfifo13  
        (.clk13(clk13), 
			.we13(push13), 
			.a(top), 
			.dpra13(bottom13), 
			.di13(data_in13[fifo_width13-1:fifo_width13-8]), 
			.dpo13(data8_out13)
		); 
...
begin
  ...
  if(push13 & ~pop13 & (count==fifo_depth13))
    overrun13   <= #1 1'b1;
end   // always


// please13 note13 though13 that data_out13 is only valid one clock13 after pop13 signal13
assign data_out13 = {data8_out13,fifo[bottom13]};

// Additional13 logic for detection13 of error conditions13 (parity13 and framing13) inside the FIFO
// for the Line13 Status Register bit 7

wire	[2:0]	word013 = fifo[0];
wire	[2:0]	word113 = fifo[1];
wire	[2:0]	word213 = fifo[2];
wire	[2:0]	word313 = fifo[3];
wire	[2:0]	word413 = fifo[4];
wire	[2:0]	word513 = fifo[5];
wire	[2:0]	word613 = fifo[6];
wire	[2:0]	word713 = fifo[7];

wire	[2:0]	word813 = fifo[8];
wire	[2:0]	word913 = fifo[9];
wire	[2:0]	word1013 = fifo[10];
wire	[2:0]	word1113 = fifo[11];
wire	[2:0]	word1213 = fifo[12];
wire	[2:0]	word1313 = fifo[13];
wire	[2:0]	word1413 = fifo[14];
wire	[2:0]	word1513 = fifo[15];

// a 1 is returned if any of the error bits in the fifo is 1
assign	error_bit13 = |(word013[2:0]  | word113[2:0]  | word213[2:0]  | word313[2:0]  |
            		      word413[2:0]  | word513[2:0]  | word613[2:0]  | word713[2:0]  |
            		      word813[2:0]  | word913[2:0]  | word1013[2:0] | word1113[2:0] |
            		      word1213[2:0] | word1313[2:0] | word1413[2:0] | word1513[2:0] );
