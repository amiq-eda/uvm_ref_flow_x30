//////////////////////////////////////////////////////////////////////
////                                                              ////
////  uart_rfifo17.v (Modified17 from uart_fifo17.v)                    ////
////                                                              ////
////                                                              ////
...
// Revision17 1.3  2003/06/11 16:37:47  gorban17
...
//
// Revision17 1.2  2002/07/29 21:16:18  gorban17
...
wire [7:0] data8_out17;
// flags17 FIFO
reg	[2:0]	fifo[fifo_depth17-1:0];
...
raminfr17 #(fifo_pointer_w17,8,fifo_depth17) rfifo17  
        (.clk17(clk17), 
			.we17(push17), 
			.a(top), 
			.dpra17(bottom17), 
			.di17(data_in17[fifo_width17-1:fifo_width17-8]), 
			.dpo17(data8_out17)
		); 
...
begin
  ...
  if(push17 & ~pop17 & (count==fifo_depth17))
    overrun17   <= #1 1'b1;
end   // always


// please17 note17 though17 that data_out17 is only valid one clock17 after pop17 signal17
assign data_out17 = {data8_out17,fifo[bottom17]};

// Additional17 logic for detection17 of error conditions17 (parity17 and framing17) inside the FIFO
// for the Line17 Status Register bit 7

wire	[2:0]	word017 = fifo[0];
wire	[2:0]	word117 = fifo[1];
wire	[2:0]	word217 = fifo[2];
wire	[2:0]	word317 = fifo[3];
wire	[2:0]	word417 = fifo[4];
wire	[2:0]	word517 = fifo[5];
wire	[2:0]	word617 = fifo[6];
wire	[2:0]	word717 = fifo[7];

wire	[2:0]	word817 = fifo[8];
wire	[2:0]	word917 = fifo[9];
wire	[2:0]	word1017 = fifo[10];
wire	[2:0]	word1117 = fifo[11];
wire	[2:0]	word1217 = fifo[12];
wire	[2:0]	word1317 = fifo[13];
wire	[2:0]	word1417 = fifo[14];
wire	[2:0]	word1517 = fifo[15];

// a 1 is returned if any of the error bits in the fifo is 1
assign	error_bit17 = |(word017[2:0]  | word117[2:0]  | word217[2:0]  | word317[2:0]  |
            		      word417[2:0]  | word517[2:0]  | word617[2:0]  | word717[2:0]  |
            		      word817[2:0]  | word917[2:0]  | word1017[2:0] | word1117[2:0] |
            		      word1217[2:0] | word1317[2:0] | word1417[2:0] | word1517[2:0] );
