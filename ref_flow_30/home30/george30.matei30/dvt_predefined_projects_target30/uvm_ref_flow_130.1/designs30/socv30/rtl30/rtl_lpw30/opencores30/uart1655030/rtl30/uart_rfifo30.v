//////////////////////////////////////////////////////////////////////
////                                                              ////
////  uart_rfifo30.v (Modified30 from uart_fifo30.v)                    ////
////                                                              ////
////                                                              ////
...
// Revision30 1.3  2003/06/11 16:37:47  gorban30
...
//
// Revision30 1.2  2002/07/29 21:16:18  gorban30
...
wire [7:0] data8_out30;
// flags30 FIFO
reg	[2:0]	fifo[fifo_depth30-1:0];
...
raminfr30 #(fifo_pointer_w30,8,fifo_depth30) rfifo30  
        (.clk30(clk30), 
			.we30(push30), 
			.a(top), 
			.dpra30(bottom30), 
			.di30(data_in30[fifo_width30-1:fifo_width30-8]), 
			.dpo30(data8_out30)
		); 
...
begin
  ...
  if(push30 & ~pop30 & (count==fifo_depth30))
    overrun30   <= #1 1'b1;
end   // always


// please30 note30 though30 that data_out30 is only valid one clock30 after pop30 signal30
assign data_out30 = {data8_out30,fifo[bottom30]};

// Additional30 logic for detection30 of error conditions30 (parity30 and framing30) inside the FIFO
// for the Line30 Status Register bit 7

wire	[2:0]	word030 = fifo[0];
wire	[2:0]	word130 = fifo[1];
wire	[2:0]	word230 = fifo[2];
wire	[2:0]	word330 = fifo[3];
wire	[2:0]	word430 = fifo[4];
wire	[2:0]	word530 = fifo[5];
wire	[2:0]	word630 = fifo[6];
wire	[2:0]	word730 = fifo[7];

wire	[2:0]	word830 = fifo[8];
wire	[2:0]	word930 = fifo[9];
wire	[2:0]	word1030 = fifo[10];
wire	[2:0]	word1130 = fifo[11];
wire	[2:0]	word1230 = fifo[12];
wire	[2:0]	word1330 = fifo[13];
wire	[2:0]	word1430 = fifo[14];
wire	[2:0]	word1530 = fifo[15];

// a 1 is returned if any of the error bits in the fifo is 1
assign	error_bit30 = |(word030[2:0]  | word130[2:0]  | word230[2:0]  | word330[2:0]  |
            		      word430[2:0]  | word530[2:0]  | word630[2:0]  | word730[2:0]  |
            		      word830[2:0]  | word930[2:0]  | word1030[2:0] | word1130[2:0] |
            		      word1230[2:0] | word1330[2:0] | word1430[2:0] | word1530[2:0] );
